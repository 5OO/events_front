    ...
    <div class="mb-4">
      <table class="table">
        ...
        <tr v-for="(participant, index) in participants" :key="participant.participantId">
          ...
          <td>
              <span class="text-dark cursor-pointer" @click="viewParticipantDetails(participant)" role="button">View</span>
      ...
      <form @submit.prevent="addParticipant">
        ...
        <div v-else-if="selectedParticipantType === 'company'">
          ...
          <div class="row form-group">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="registrationCode" v-model="companyForm.registrationCode" required />
            </div>
          </div>
          <div class="row form-group">
            <label for="numberOfParticipants" class="col-sm-2 col-form-label">Number of Participants:</label>
            <div class="col-sm-4">
              <input type="number" class="form-control" id="numberOfParticipants" v-model="companyForm.numberOfParticipants" required />
            </div>
          </div>
          <div class="row form-group">
            <label for="paymentMethod" class="col-sm-2 col-form-label">Payment Method:</label>
